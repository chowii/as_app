 ...
 */
class SSNotSureOverlayView : FrameLayout {
    ...
    val contentView: LinearLayout by bindView(R.id.notSureContainerView)
    ...
    private fun setup() {
        View.inflate(context, R.layout.overlay_onboarding_not_sure, this)
