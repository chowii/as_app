package au.com.ahbeard.sleepsense.backend;
...
public class GoogleCloudeStorageServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if ( "/gcs/example".equals(req.getRequestURI()) ) {

            ListResult listResult = gcsService.list("example", ListOptions.DEFAULT);

            while (listResult.hasNext()) {
                ListItem listItem = listResult.next();
                resp.getOutputStream().print(listItem.getName());
            ...
            if (SERVE_USING_BLOBSTORE_API) {
                ...
                // This is where we would pull the stream back.
